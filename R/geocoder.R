...
# From: http://www.shanelynn.ie/massive-geocoding-with-r-and-google-maps/
# Adapted for my purposes: RS04092015

# Load up the ggmap library
library(ggmap)
# get the input data
setwd("~/Develop/prop_vis/data")
...
write.table(data, file = paste0("data/", infile ,"_geocoded.csv"), 
            sep = ",", row.names = FALSE)
